...
*/
	...
	*         return null if fail
	 * @throws Exception 
	*/
	public FileInfoBean upload_file1(String local_filename, String file_ext_name, 
	       NameValuePair[] meta_list) throws Exception
	{
		String parts[] = this.upload_file(local_filename, file_ext_name, meta_list);
		if (parts != null)
		{
			return new FileInfoBean(parts[0], parts[1], SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR, parts[2]);
		}
		else
		{
			return null;
	...
	*         return null if fail
	 * @throws Exception 
	*/
	public FileInfoBean upload_file1(String group_name, String local_filename, String file_ext_name, 
	       NameValuePair[] meta_list) throws Exception
	{
	...
	*         return null if fail
	 * @throws Exception 
	*/
	public FileInfoBean upload_file1(byte[] file_buff, String file_ext_name,	
	       NameValuePair[] meta_list) throws Exception
	{
	...
	*         return null if fail
	 * @throws Exception 
	*/
	public FileInfoBean upload_file1(String group_name, byte[] file_buff, String file_ext_name,	
	       NameValuePair[] meta_list) throws Exception
	{
